...
require 'XJRA/_Cache.php';
require 'XJRA/_Method.php';
require 'XJRA/Addons.php';
require 'XJRA/Application.php';
require 'XJRA/AudioLibrary.php';
require 'XJRA/Files.php';
require 'XJRA/GUI.php';
require 'XJRA/Input.php';
require 'XJRA/JSONRPC.php';
require 'XJRA/PVR.php';
require 'XJRA/Player.php';
require 'XJRA/Playlist.php';
require 'XJRA/System.php';
require 'XJRA/VideoLibrary.php';
require 'XJRA/XBMC.php';
